...
$string['manage_tiercredits'] = 'Credits';
$string['manage_tiercourses'] = 'Course limit';
...
$string['error_tiercreditnumber'] = 'Tier credits must be greater than or equal to 0.';
$string['error_tiercoursenumber'] = 'Tier course limit must be greater than or equal to 0.';
...
$string['event_creditlimitreached'] = 'The client \'{$a->clientname}\' ({$a->origin}) has reached its credit limit ({$a->creditlimit}).';
...
$string['errorpage_creditlimittitle'] = 'Credit limit reached';
$string['errorpage_creditlimitmessage'] = 'Credit limit has been reached. Contact your teacher to resolve this problem. Domain: {$a->domain}';
...
$string['privacy:metadata:mod_scormremote:credits'] = 'The maximum allowable credits per year.';
$string['privacy:metadata:mod_scormremote:maxcourses'] = 'The maximum number of courses allowed.';
$string['privacy:metadata:mod_scormremote:scormremote_credit_usage'] = 'Tracks credit usage per client.';
$string['privacy:metadata:mod_scormremote:scormremote_credit_usage:clientid'] = 'The client id.';
$string['privacy:metadata:mod_scormremote:scormremote_credit_usage:userid'] = 'The user id.';
$string['privacy:metadata:mod_scormremote:scormremote_credit_usage:courseid'] = 'The course id.';
$string['privacy:metadata:mod_scormremote:scormremote_credit_usage:timecreated'] = 'The time when the credit was used.';
$string['report:scores'] = 'Learner score report';
$string['report:heading'] = 'Learner scores';
$string['report:allcourses'] = 'All courses';
$string['report:allclients'] = 'All clients';
$string['report:applyfilters'] = 'Apply filters';
$string['report:clearfilters'] = 'Clear filters';
$string['report:noresults'] = 'No matching records were found.';
$string['report:score'] = 'Score';
$string['report:noclient'] = 'Unknown client';
$string['report:searchplaceholder'] = 'Search learners';
